...
USERAPI_DIR="${PROJECT_DIR}/auth"
RELEASES_DIR="${PROJECT_DIR}/releases/auth"
TIMESTAMP=$(date +"%Y%m%d%H%M%S")
RELEASE_NAME="mpl-auth-service-${TIMESTAMP}"
...
dotnet clean MplAuthService.sln --configuration Release
dotnet publish src/MplAuthService/MplAuthService.csproj \
